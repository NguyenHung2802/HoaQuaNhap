...
| [GĐ 3](docs/phases/03-category-product.md) | **Quản lý SP & DM**, Upload ảnh, Tồn kho. | ✅ Hoàn thành |
| [GĐ 4](docs/phases/04-public-site.md) | **Public Website**, Home, Shop, Listing. | ✅ Hoàn thành |
| [GĐ 5](docs/phases/05-cart-order.md) | **Giỏ hàng & Checkout**, Tạo Order (COD). | ✅ Hoàn thành |
| [GĐ 6](docs/phases/06-admin-op.md) | **Vận hành admin**, Cập nhật đơn, Dashboard. | ✅ Hoàn thành |
| [GĐ 7](docs/phases/07-content.md) | **Nội dung**, Blog, Banner, SEO hỗ trợ. | ✅ Hoàn thành |
| [GĐ 8](docs/phases/08-optimization.md) | **Nâng cao**, Voucher, Báo cáo, Nâng cấp UI/UX Premium. | ✅ Hoàn thành |
